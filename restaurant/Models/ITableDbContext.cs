...
//        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=iTableDb;Integrated Security=True;Trusted_Connection=True;TrustServerCertificate=True;User ID=sa;Password=1234");
